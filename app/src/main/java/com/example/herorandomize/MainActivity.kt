...
request()
    ...
    fun request(){
        val url1 = "https://cdn.jsdelivr.net/gh/akabab/superhero-api@0.3.0/api/id/186.json"
        val url2 = "https://cdn.jsdelivr.net/gh/akabab/superhero-api@0.3.0/api/id/181.json"
